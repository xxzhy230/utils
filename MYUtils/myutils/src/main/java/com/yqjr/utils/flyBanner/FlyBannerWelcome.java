 ...
 */
public class FlyBannerWelcome extends RelativeLayout {
    ...
    public FlyBannerWelcome(Context context) {
        this(context, null);
    }

    public FlyBannerWelcome(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlyBannerWelcome(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param type 指示器类型
     */
    public void setImagesUrl(List<String> urls, int type) {
        //加载网络图片
        mIsImageUrl = true;
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (mIsImageUrl) {
                Picasso.with(Utils.mContext)
                        .load(mImageUrls.get(toRealPosition(position))).config(Bitmap.Config.RGB_565).into(imageView);
            } else {
